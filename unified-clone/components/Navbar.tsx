        ...
        <nav className="hidden items-center gap-8 text-sm font-medium text-slate-300 md:flex">
          ...
          <div className="relative group">
            ...
            <div className="absolute left-0 top-full z-50 pt-2">
              <div className="w-56 translate-y-2 rounded-2xl border border-white/10 bg-[#0b1226] p-2 opacity-0 invisible shadow-lg shadow-black/30 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100 group-hover:visible">
